...
public class ControllerActivity extends AppCompatActivity {
        ...
        mHandler = new Handler(){
            public void handleMessage(android.os.Message msg){
                ...
                if(msg.what == CONNECTING_STATUS){
                    if(msg.arg1 == 1)
                        Log.i(TAG, "handleMessage: "+"Connected to Device: " + (String)(msg.obj));
                    else
                        Log.i(TAG, "handleMessage: Connection Failed");
                }
            }
        };
    ...
    private void bluetoothOn(View view){
        if (!mBTAdapter.isEnabled()) {
            ...
            Log.i(TAG, "bluetoothOn: BTenabled");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent Data){
        ...
        if (requestCode == REQUEST_ENABLE_BT) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Log.i(TAG, "onActivityResult: enabled");
            }
            else
                Log.i(TAG, "onActivityResult: disabled");
        }
    }

    private void bluetoothOff(View view){
        mBTAdapter.disable(); // turn off
        Log.i(TAG, "bluetoothOff: BTdisabled");
